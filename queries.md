...
15. [CHECK - Dodanie constraint CHECK, aby zapewnić, że rabat nie może być mniejszy niż 0 i nie większy niż 100.](#zapytanie-10)
16. [UNIQUE - Zmiana kolumny 'nazwa', aby była unikalna. Oznacza to, że każda promocja będzie miała inną nazwę.](#zapytanie-11)
17. [DEFAULT - Ustawienie wartości domyślnej dla kolumny 'data_rozpoczecia', aby była ustawiona na dzisiejszą datę, jeśli użytkownik jej nie poda.](#zapytanie-12)
18. [INDEX - Stworzenie indeksu dla kolumny 'data_rozpoczecia', aby przyspieszyć wyszukiwanie promocji po dacie rozpoczęcia.](#zapytanie-13)
19. [TRUNCATE TABLE - Usunięcie wszystkich danych z tabel](#zapytanie-14)
20. [DROP TABLE - Całkowite usunięcie tabeli z bazy danych](#zapytanie-15)


zapytania i grupowanie

21. [SELECT,WHERE,LIKE - Wybierz wszystkich klientów z miasta Stalowa Wola](#zapytanie-16)
22. [BETWEEN - Wybór produktów z przedziału 300 do 800 zł](#zapytanie-17)
23. [WHERE IN - wyszukaj pracowników o imieniu Piotr lub Paweł](#zapytanie-18)
24. [ORDER BY - Sortowanie wyników według daty zamówienia](#zapytanie-19)
25. [ORDER BY,TOP - Pobranie pięciu ostatnich wysłąnych zamówień](#zapytanie-20)
26. [DISTINCT - Wyszukaj wszystkie stanowiska w firmie](#zapytanie-21)
27. [GROUP BY,COUNT - Grupowanie zamówień według statusu zamówienia](#zapytanie-22)
28. [GROUP BY, HAVING - Wyszukaj klientów,którzy złożyli więcej niż jedno zamówienie](#zapytanie-23)
29. [GROUP BY,SUM - Obliczenie łącznej wartości zamówień](#zapytanie-24)
30. [GROUP BY,AVG,AS - Grupowanie produktów według typu i wyciąganie średniej ceny](#zapytanie-25)
31. [CASE - Dodanie kolumny, która kategoryzuje rabaty na "Wysoki" lub "Niski"](#zapytanie-25)
32. [MIN,MAX - Wybranie najwcześniejszej i najpóźniejszje daty zamówienia w tabeli](#zapytanie-25)
